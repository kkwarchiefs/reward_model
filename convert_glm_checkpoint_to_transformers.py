...
def convert_glm_checkpoint_to_transformers(checkpoint_path, root_output_path, copy_dict=None):
    ...
    output_path = os.path.join(root_output_path, "pytorch_model.bin")
...
if __name__ == "__main__":
    ...
    convert_glm_checkpoint_to_transformers(checkpoint_path, root_output_path, copy_dict)
