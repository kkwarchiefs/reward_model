    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(name=datasets.Split.TRAIN,
                                    gen_kwargs={"filepath": '/search/ai/jamsluo/GLM_RLHF/reward_model/qa_data/squad_cmrc_checklist_wiki_nyt_train.json'}),
            datasets.SplitGenerator(name=datasets.Split.VALIDATION,
                                    gen_kwargs={"filepath": '/search/ai/jamsluo/GLM_RLHF/reward_model/qa_data/squad_cmrc_checklist_wiki_nyt_dev.json'}),
        ]
